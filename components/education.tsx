  ...
  const qualifications = [
    {
      ...
      description:
        "Comprehensive training in patient care, medical procedures, and healthcare management",
    },
    {
      type: "Diploma",
      title: "GDPR Compliance & Data Protection",
      description:
        "Professional certification in data protection regulations and compliance standards",
    },
  ];
  ...
  return (
    <section className="border-b border-border px-6 sm:px-10 md:px-16 py-12 md:py-20">
      ...
      <div className="max-w-4xl space-y-10 md:space-y-14">
        <div>
          <h4 className="font-medium text-foreground mb-4 md:mb-6 text-lg">
            Qualifications
          </h4>
          <div className="space-y-4 md:space-y-6">
            {qualifications.map((qual, idx) => (
              <div key={idx} className="border-l-2 border-accent pl-4 md:pl-6">
                <p className="text-xs md:text-sm text-accent font-medium mb-1">
                  {qual.type}
                </p>
                <h5 className="text-base md:text-lg font-medium text-foreground mb-1">
                  {qual.title}
                </h5>
